...
sleep 20
nohup /home/pi/CodeDev/MilanoWaterProject/bin/subscriber > /dev/null 2>&1 &
echo "Done"
echo "Starting Monitor App"
sleep 20
nohum /home/pi/CodeDev/MilanoWaterProject/bin/monitor > /dev/null 2>&1 &
sleep 20
echo "Starting Blynk Interface"
nohup /home/pi/CodeDev/MilanoWaterProject/bin/blynk > /dev/null 2>&1 &
echo "Done"
sleep 30m
